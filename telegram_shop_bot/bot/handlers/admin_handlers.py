...
def get_language_keyboard():
    return InlineKeyboardMarkup(inline_keyboard=[
        [InlineKeyboardButton(text="Ukrainian", callback_data="admin_lang_ua")],
        [InlineKeyboardButton(text="English", callback_data="admin_lang_en")],
        [InlineKeyboardButton(text="Polish", callback_data="admin_lang_pl")],
        [InlineKeyboardButton(text="Russian", callback_data="admin_lang_ru")],
    ])
